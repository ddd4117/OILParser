...
public class OilSpec {
	...
	/** The list of OIL counter */
	private OilCounter counter;
	/**
	...
	public void addCounter(OilCounter counter){
		setCounter(counter);
	}
	/**
	...
	public String toString() {
		...
		if(this.getCounter() != null)
			result += "Counter Name: " + this.getCounter().toString() + "\n";
		return result;
	}
	...
	public OilCounter getCounter() {
		return counter;
	}

	public void setCounter(OilCounter counter) {
