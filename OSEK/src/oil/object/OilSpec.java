...
public class OilSpec {
  ...
  private static final Logger LOGGER = Logger
      .getLogger(OilSpec.class.getName());
  ...
  public OilSpec() {
    try {
      this.setAppMode(new OilAppMode("default"));
   ...
   * @param name of obj
   * @return id of objName
   *    return -1 if there is no object having objName
   */
  ...
  public String toString() {
    ...
    result += "APPMODE: " + this.getAppMode() + "\n";
    result += "CPU name: " + this.getCpuName() + "\n";
